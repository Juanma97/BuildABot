<template>
  <div>
    ...
    <div class="middle-row">
      <div class="left part">
        <img :src="selectedRobot.armLeft.src" title="left arm"/>
      ...
      <div class="right part">
        <img :src="selectedRobot.armRight.src" title="left arm"/>
...
export default {
  ...
  methods: {
    ...
    selectPreviousBottom() {
      this.selectedBottomIndex = getPreviousValidIndex(this.selectedBottomIndex,
  ...
  computed: {
    selectedRobot() {
      return {
        ...
        armRight: availableParts.arms[this.selectedRightArmIndex],
        armLeft: availableParts.arms[this.selectedLeftArmIndex],
